    ...
    <section className="relative w-full md:py-16 py-16 px-6 md:px-12 z-10 max-w-7xl mx-auto">
      ...
      >
        ...
        >
          <Badge
            variant="secondary"
            className="mb-8 bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-500/20 px-4 py-1.5 text-sm font-medium border-0 transition-colors"
          >
          ...
          >
            ...
            <Button
              ...
              variant="ghost"
              size="lg"
              className="rounded-full px-6 h-12 text-foreground/70 hover:text-foreground"
              onClick={() =>
                toast.success('My CV is on its way. Thanks for taking a look')
              }
            >
              <a href="/files/Md-Umar-Siddique-Resume.pdf" download>
        ...
        >
          ...
          <div className="flex items-center gap-2 text-sm font-medium text-foreground/70 mt-6 mb-8 bg-foreground/5 px-3 py-1.5 rounded-full w-fit">
